...
$BuildProjectFile = "$PSScriptRoot\Deployment\Deployment.csproj"
...
$NugetConfigPath="$PSScriptRoot\.nuget\NuGet.Config";
ExecSafe { & $env:DOTNET_EXE restore $BuildProjectFile --configfile $NugetConfigPath}
ExecSafe { & $env:DOTNET_EXE run --project $BuildProjectFile -- $BuildArguments --no-restore }
